...
namespace Spider.NgTable.Core
{
    ...
    public class TableFilterManager<TEntity> : ITableFilterManager<TEntity>
    {
            ...
            tableFilterPayload.MultiSortMeta.Select((value, i) => new { i, value }).ToList().ForEach(o =>
              {
                  ...
                  {
                      case (int)SortingCodes.OrderByAsc:
                          if (o.i == 0)
                      ...
                      case (int)SortingCodes.OrderByDesc:
                          if (o.i == 0)
        ...
        public void FilterDataSet(string key, TableFilterContext value)
            => BaseFilterDataSet(key, value, OperatorCodes.None);
        ...
        private void BaseFilterDataSet(string key, TableFilterContext value, OperatorCodes operatorAction)
        {
            if (value.Value == null)
                return;
