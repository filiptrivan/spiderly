...
namespace Spider.NgTable.Core
{
    public class LinqOperator<TEntity> : ILinqOperator<TEntity>
    {
        ...
        private void AddNormalExpression(OperatorCodes operatorAction, Expression propertyAccess)
        {
        ...
        private void AddNegationExpression(OperatorCodes operatorAction, Expression propertyAccess)
        {
            AddLambdaExpression(operatorAction, Expression.Not(propertyAccess));

        }

        private void AddLambdaExpression(OperatorCodes operatorAction, Expression callMethod)
        {
        ...
        private void ComposeLambdaForNumericProperty(string propertyName, string extensionMethod, OperatorCodes operatorAction, bool isNegation, object castValue)
        {
        ...
        private void ComposeEqualsLinqExpression(string propertyName, OperatorCodes operatorAction,
        ...
        /// <param name="isNegation">Flag that indicates if expression should be negation</param>
        /// <param name="castValue">Casted value of <paramref name="propertyName"/></param>
        private void ComposeLambdaForDateTimeProperty(string propertyName, string extensionMethod, OperatorCodes operatorAction, bool isNegation, DateTime dateTime)
        {
            LambdaExpression dynamicExpression;
