        ...
        return new Promise((resolve) => {
            ...
            img.onload = () => {
                ...
                if (imageWidth > 0 && width !== imageWidth) {
                    errors.push(this.translocoService.translate('ImageWidthMustBeExact', { 0: imageWidth, 1: width }));
                }

                if (imageHeight > 0 && height !== imageHeight) {
                    errors.push(this.translocoService.translate('ImageHeightMustBeExact', { 0: imageHeight, 1: height }));
                }
