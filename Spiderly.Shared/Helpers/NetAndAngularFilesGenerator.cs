            ...
            return $$$"""
{
    ...
    "DeleteBulkConfirmation": "Da li ste sigurni da želite da obrišete {{count}} stavki?",
    "Cancel": "Odustanite",
    "Confirm": "Potvrdite",
    "Clear": "Uklonite",
    ...
    "MaxLength": "Polje mora da ima maksimum {{max}} karaktera.",
    "SingleLength": "Polje mora da ima {{length}} karaktera.",
    "NumberRangeMin": "Vrednost polja mora da bude veća ili jednaka {{min}}.",
    "NumberRangeMinNumberRangeMax": "Vrednost polja mora da bude između {{min}} i {{max}}.",
    "PrecisionScale": "Vrednost polja mora da ima ukupno {{precision}} cifara, i broj cifara nakon zareza ne sme biti veći od {{scale}}.",
    "NumberRangeMinPrecisionScale": "Vrednost polja mora da bude veća ili jednaka {{min}}, mora da ima ukupno {{precision}} cifara, i broj cifara nakon zareza ne sme biti veći od {{scale}}.",
    "NotEmptyLength": "Polje ne sme biti prazno i mora da ima minimum {{min}}, a maksimum {{max}} karaktera.",
    "NotEmptyMaxLength": "Polje ne sme biti prazno i mora da ima maksimum {{max}} karaktera.",
    ...
    "NotEmptyNumberRangeMinNumberRangeMax": "Polje ne sme biti prazno i vrednost mora da bude između {{min}} i {{max}}.",
    "NotEmptyPrecisionScale": "Polje ne sme biti prazno, vrednost mora da ima ukupno {{precision}} cifara, i broj cifara nakon zareza ne sme biti veći od {{scale}}.",
    "NotEmptyNumberRangeMinPrecisionScale": "Polje ne sme biti prazno, vrednost mora da bude veća ili jednaka {{min}}, mora da ima ukupno {{precision}} cifara, i broj cifara nakon zareza ne sme biti veći od {{scale}}.",
    ...
    "FileSizeExceeded": "Veličina fajla ne sme da prelazi {{ 0 }} MB.",
    "IdToken": "/",
    "Browser": "/",
