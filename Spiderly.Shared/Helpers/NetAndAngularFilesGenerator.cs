                        ...
                        ChildFolders =
                        {
                            ...
                            new SpiderlyFolder
                            {
                                ...
                                Files =
                                {
                                    ...
                                    new SpiderlyFile { Name = "TermsGenerated.generated.cs", Data = GetTermsGeneratedStubCsData(appName) },
                                }
                            },
                            new SpiderlyFolder
                            {
                                ...
                                Files =
                                {
                                    new SpiderlyFile { Name = "en.json", Data = "{}" },
                                }
                            }
                        },
                        Files =
        ...
        public void Configure(MvcOptions options)
        {
            ValidatorOptions.Global.DisplayNameResolver = (type, memberInfo, expression) =>
            {
                string translatedPropertyName =
                    TermsGenerated.GetTranslation(memberInfo.Name) ??
...
""";
    ...
    private static string GetTermsGeneratedStubCsData(string appName)
    {
      return $$"""
...
namespace {{appName}}.Shared.Resources
{
    public static class TermsGenerated
    {
        ...
        public static string GetTranslation(string key)
        {
            ...
            if (_translations.TryGetValue(langCode, out Dictionary<string, string> langDict) && langDict.TryGetValue(key, out string value) && !string.IsNullOrEmpty(value))
                return value;

            return null;
        }

        public static string GetExcelTranslation(string excelKey, string pluralKey)
        {
            string result = GetTranslation(excelKey);

            if (result == null)
                result = GetTranslation(pluralKey);

            if (result == null)
                result = Spiderly.Shared.Resources.SharedTerms.ResourceManager.GetTranslation(pluralKey);
