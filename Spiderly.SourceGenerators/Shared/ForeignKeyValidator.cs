...
namespace Spiderly.SourceGenerators.Shared
{
    ...
    public static class ForeignKeyValidator
    {
        ...
        /// <summary>
        /// The navigation's <c>[Required]</c> must agree with its explicit FK scalar's nullability. Distinct
        /// from SPIDERLY028 (<see cref="NullabilityValidator"/>), which compares ONE property's own
        /// annotation with its own <c>[Required]</c>; this compares two different properties.
        /// </summary>
        private static void ValidateNullabilityAlignment(SpiderlyProperty navigation, SpiderlyProperty fkProperty, SpiderlyClass entity)
        {
            ...
            bool fkIsNullable = fkProperty.Type.IsNullable;
            ...
            List<SpiderlyClass> allEntities)
        {
            ...
            string fkType = fkProperty.Type.CoreName;
