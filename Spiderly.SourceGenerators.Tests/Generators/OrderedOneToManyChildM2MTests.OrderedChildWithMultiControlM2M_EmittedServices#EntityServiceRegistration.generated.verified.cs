...
namespace TestApp.Business.Services
{
    ...
    public static class EntityServiceRegistration
    {
        public static IServiceCollection AddEntityServices(this IServiceCollection services)
        {
            ...
            services.AddTransient<BoardServiceGenerated>();
            services.AddTransient<BoardLaneServiceGenerated>();
            services.AddTransient<BoardLaneLabelServiceGenerated>();
            services.AddTransient<BoardLaneMemberServiceGenerated>();
            services.AddTransient<LabelServiceGenerated>();
